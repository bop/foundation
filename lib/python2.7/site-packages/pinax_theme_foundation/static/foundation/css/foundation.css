...
body { background: white; font-family: "Helvetica Neue", "Helvetica", Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1; color: #444; position: relative; -webkit-font-smoothing: antialiased; 
       background-image:url(/site_media/static/images/dj33.jpg);
...
/* Panels ---------------------- */
.panel { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(176,176,176,0.5); list-style-type: none }
.panelGreen { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(120,200,50,0.7); }
.panelBlue { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(100,0,250,0.7);  color: white}
.panelYlw { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(250,0,150,0.7); list-style-type: none }
.panelRed { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(0,120,200,0.7);  color: white}
.panelRed a{color:white; padding-left:10px}
.panelBlue a{ color: white; margin-left:10px}
