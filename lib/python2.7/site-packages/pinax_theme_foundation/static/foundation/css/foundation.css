...
h1 { font-size: 96px; color: #777; text-align: center; }

h2 { font-size: 37px; color: rgba(255,216,1,0.9); background-color: #111; text-align: center; }
...
.panelBlue { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(100,0,250,0.9);  color: white}
...
.panelRed { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(0,120,200,0.9);  color: white}
