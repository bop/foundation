...
body { background: white; font-family: "Helvetica Neue", "Helvetica", Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1; color: silver; position: relative; -webkit-font-smoothing: antialiased; 
       background-image:url(/site_media/static/images/djpx2.jpg);
...
ul.side-nav li a { display: block; background-color: #555; text-align: center;font-size: 120%; font-weight: 700; font-family: TimesNR;}
ul.side-nav li a:hover { display: block; color: cyan;}

ul.side-nav li.active a { color: silver; font-weight: bold; }
