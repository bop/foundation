...
/* Panels ---------------------- */
.panel { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(176,176,176,0.5);}
...
.panelYlw { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(250,0,150,0.7);}
