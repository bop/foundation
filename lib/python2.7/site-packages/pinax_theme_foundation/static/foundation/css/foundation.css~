...
body { background: white; font-family: "Helvetica Neue", "Helvetica", Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1; color: silver; position: relative; -webkit-font-smoothing: antialiased; 
       background-image:url(/site_media/static/images/dj.jpg);
...
h1 { font-size: 96px; color: #2284a1; text-align: center; }

h2 { font-size: 37px; color:#E5E4E2 ; background-color: #222; text-align: center; }
h2.red { font-size: 37px; color:rgba(250,0,0,0.6); background-color: #222; text-align: center; }
h2.yellow { font-size: 37px; color:rgba(255,216,1,0.9); background-color: #222; text-align: center; }

h2.flat {background-color: transparent; color: #777 }
...
ul.orbit-bullets li {
    background: url("../images/foundation/orbit/bullets.png") no-repeat scroll 4px 0 transparent;
    color: #999999;
    cursor: pointer;
    float: left;
    height: 12px;
...
/* Panels ---------------------- */
.panel { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(176,176,176);}
.panelGreen { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(120,200,50,0.9);  color: white}
.panelBlue { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(100,0,250,0.9);  color: white;  border-color: #2284a1; -webkit-box-shadow: inset 0px 1px 0px rgba(255, 255, 255, 0.5); -moz-box-shadow: inset 0px 1px 0px rgba(255, 255, 255, 0.5); box-shadow: inset 0px 1px 0px rgba(255, 255, 255, 0.5);}
.panelYlw { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(255,216,1,0.9);  color: white}
.panelRred { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(250,0,0,0.6);  color: white}
.panelRed { background: #f2f2f2; border: solid 1px #e6e6e6; margin: 0 0 22px 0; padding: 20px; background-color:rgba(0,120,200,0.9);  color: white;  border-color: #2284a1; -webkit-box-shadow: inset 0px 1px 0px rgba(255, 255, 255, 0.5); -moz-box-shadow: inset 0px 1px 0px rgba(255, 255, 255, 0.5); box-shadow: inset 0px 1px 0px rgba(255, 255, 255, 0.5);}
.panelRed a{color:#CCFFFF; margin-left:10px}
.panelRed a:hover{color:#00FFFF; padding-left:10px}
.panelBlue a{ color: #CCFFFF; margin-left:10px}
.panelBlue a:hover{color:#00FFFF; padding-left:10px}
...
/* Side Nav ---------------------- */
ul.side-nav {list-style: url(http://img15.hostingpics.net/pics/343185flamme.gif); margin-left: 220px;}
ul.side-nav li {margin: 0 2px 7px 0; list-style-image: url(http://img15.hostingpics.net/pics/343185flamme.gif);}
ul.side-nav li a { display: block; background-color: #555; text-align: left; font-size: 120%; font-weight: 700; font-family: TimesNR;}
ul.side-nav li a:hover { display: block; color: cyan; padding-left: 15px; background-color: #444;}

ul.side-nav li.active a { color: cyan; font-weight: bold; text-align: center; background-color: #444;}
...
.banner {
    color: #837E7C; background-color: transparent; text-align: left;
}


.side-bar ul li{
	list-style-position: inside;
	list-style-image: url(http://img15.hostingpics.net/pics/343185flamme.gif);
}
